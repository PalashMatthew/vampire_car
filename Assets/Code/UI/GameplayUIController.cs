...
public class GameplayUIController : MonoBehaviour
{
    ...
    public void StartWave(int _waveTime, int _waveNum)
    {
        ...
        {
            tWaveTimer.text = PlayerPrefs.GetString(PlayerPrefs.GetString("activeLang") + "LOC_waveTimer") + " " + _waveNum + "/10 - 00:" + _currentWaveTime;
        }
        else
        {
            tWaveTimer.text = PlayerPrefs.GetString(PlayerPrefs.GetString("activeLang") + "LOC_waveTimer") + " " + _waveNum + "/10 - 00:0" + _currentWaveTime;
        }
    ...
    IEnumerator WaveTimer(int _saveWaveTime, int _waveNum)
    {
        ...
        {
            tWaveTimer.text = PlayerPrefs.GetString(PlayerPrefs.GetString("activeLang") + "LOC_waveTimer") + " " + _waveNum + "/10 - 00:00";
